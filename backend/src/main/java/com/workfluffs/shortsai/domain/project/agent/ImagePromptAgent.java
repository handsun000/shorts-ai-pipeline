...
public interface ImagePromptAgent {
    ...
    @SystemMessage("""
            ...
            Write an image generation prompt for a SPECIFIC CUT of a storyboard.
            MUST BE IN ENGLISH. MUST BE 9:16 aspect ratio.
            If a reference character/setting is provided, ensure those details are perfectly maintained.
            Format:
            ...
            """)
    String generateImagePrompt(@UserMessage String cutDescription);
}
